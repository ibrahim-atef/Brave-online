...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> getCategoriesData() async {
    ...
    setState(() {
      roles = allCategories
          .where(
              (i) => i.title != null && i.id != null) // تأكد من عدم وجود null
              ...
              child: Column(
                ...
                children: [
                  ...
                  input(nameController, nameNode, appText.name,
                      iconPathLeft: '', leftIconSize: 14, isPassword: false),

                  space(16),

                  input(phoneController, phoneNode, appText.phoneNumber,
                      iconPathLeft: '', leftIconSize: 14, isPassword: false),
